...
import Tracker_library3 as Lbr
...
coef = np.linspace(0.0001, 0.5, 10)



labels2, n_clusters2, n_noise2, Cluster2, Index_cluster2, Index_layer2, t_index2, z_index2, BIB_true2 = Lbr.Lbr_Clustering( R_mix, index1, t_mix, z_mix, BIBorTOP_mix)

# print(len(Index_cluster2))
#print(Cluster2)
# print(len(Index_layer2))
...
NombreTotalTrace, NombreTotalTraceTrue, pourcentage = Lbr.Lbr_AnalyseTrace2(Coef, Index_layer, BIB_true)
